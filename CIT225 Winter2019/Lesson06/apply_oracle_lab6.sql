...
-- from mclaughlin, to verify completion
...
-- mclaughlin's tabel creation verification query
...
-- mclaughlin's query to verify completion of the contraint step
...
-- mchaughlin's query to verify column rename
...
-- mclaughlin's query to see if it worked
...
-- mclaughlin's query for the rental and rental item changes
...
-- mclaughlin's query to verify the inexes have been dropped
...
-- mclaughlin's query to verify addition of columns    
...
-- update common lookup table multiple
...
-- verify new structure of common lookup table
...
-- verify new unique natural key index
...
-- verify update incorrect foreign keys
